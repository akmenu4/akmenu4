// clang-format off
/*
    This file is a part of Pico Launcher (picoLoader7.h)
...
typedef struct
{
    ...
    // AKMENU CHANGES START - use const void to avoid compiler error
    const void* dldiDriver;
    // AKMENU CHANGES END - use const void to avoid compiler error
