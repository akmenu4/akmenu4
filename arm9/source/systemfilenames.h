...
=======
#define SFN_CHEATS SFN_SYSTEM_DIR + "cheats/usrcheat.dat"
>>>>>>> 7a67e88 (Properly handle filesystem. Removed the requirement for separate binaries to be built. Added support to load games from both fat:/ and sd:/ on DSpico (or future DSi mode flashcarts))
